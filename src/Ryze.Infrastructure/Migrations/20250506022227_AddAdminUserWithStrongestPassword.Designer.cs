            ...
            modelBuilder.Entity("Ryze.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BirthDate = new DateTime(2005, 5, 6, 2, 22, 27, 360, DateTimeKind.Utc).AddTicks(6532),
                            CreatedAt = new DateTime(2025, 5, 6, 2, 22, 27, 360, DateTimeKind.Utc).AddTicks(6027),
                            Email = "admin@admin.com",
                            FirstLogin = false,
                            Gender = 3,
                            IsActive = true,
                            Name = "ADMIN",
                            Password = "$2a$11$lpUoHmJRBr1K.32vhgDtIenVAN3V1wUG6RPItws1qi/2ohUMdTjdK",
                            Phone = "(11) 99999-9999",
                            Role = "GlobalAdmin",
                            UpdatedAt = new DateTime(2025, 5, 6, 2, 22, 27, 360, DateTimeKind.Utc).AddTicks(6258)
                        });
                });
